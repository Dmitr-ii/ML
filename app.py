...
@st.cache
def read_files(folder_name='C:/Users/Dmitriy/anaconda3/ML treck'):
    """
...
def load_embeddings(file_name='C:/Users/Dmitriy/anaconda3/ML treck/item_embeddings.pkl'):
    """
...
#Загружаем данные
ratings, books = read_files(folder_name='C:/Users/Dmitriy/anaconda3/ML treck')
